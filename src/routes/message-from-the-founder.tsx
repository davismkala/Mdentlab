      ...
      <Section>
        <div className="prose-mdent measure text-base leading-relaxed text-muted-foreground">
          ...
          <p>
            ...
            hand-cast metal frameworks to CAD/CAM milling and 3D printing — but that original
            promise hasn't. Every case that comes through our laboratory, whether it's a single
            crown or a full-arch rehabilitation, gets the same attention from our technicians that
            it did when we were a much smaller operation.
          </p>
          <p>
